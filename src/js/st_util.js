export function getValue (current, key) {
...
export function findPos (current, node) {
...
export function BaseRotate (node, parent, index) {
...
export function BaseOrderTraversal (node) {
	const order = { str: "" };
	MinOrder(node, order);
	return order.str;
}
